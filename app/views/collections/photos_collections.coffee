...
itemView       = require 'views/collections/photos_collections_item'
template       = require 'views/templates/photo_collection'

module.exports = class PhotosCollectionsView extends CollectionView
  template: template
  ...
  initialize: (options) ->
    super
    log 'Initializing the Photos Collections CollectionView'
